...
if [[ $- == *i* ]]; then
    # This code runs ONLY for interactive shells
    export SHELL_STATUS="interactive"
    ...
    # This code runs for scripts and non-interactive sessions
    export SHELL_STATUS="non-interactive"
    source "$HOME/dotfiles/zsh/nix/agent/.zshrc"
fi