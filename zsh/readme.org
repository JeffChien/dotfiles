...
- [[#rcfiles][rcfiles]]
  - [[#bootstrap][bootstrap]]
  - [[#v10-complex-version][V1.0 Complex version]]
  - [[#v200-simplify-version][V2.0.0 Simplify version]]
- [[#gnu-stow][Gnu stow]]
- [[#tagging][Tagging]]
...
| dir_v2.0.0 | .build/.config/zsh/v2.0.0/ | dotfile target folder for v2.0.0 |
...
** V2.0.0 Simplify version
#+begin_src emacs-lisp
(org-sbe helper.org.resolve-path (vardir 'dir_v2.0.0) (path $".zshenv"))
#+end_src

#+RESULTS:
: .build/.config/zsh/v2.0.0/.zshenv

*** zshenv
#+begin_src shell :tangle (org-sbe helper.org.resolve-path (vardir 'dir_v2.0.0) (path $".zshenv"))
export XDG_CONFIG_HOME=${XDG_CONFIG_HOME:-$HOME/.config}
export XDG_CACHE_HOME=${XDG_CACHE_HOME:-$HOME/.cache}
export XDG_DATA_HOME=${XDG_DATA_HOME:-$HOME/.local/share}
export XDG_RUNTIME_DIR=${XDG_RUNTIME_DIR:-$HOME/.xdg}
...
*** zprofile
:PROPERTIES:
:header-args: :tangle (org-sbe helper.org.resolve-path (vardir 'dir_v2.0.0) (path $".zprofile"))
:END:
#+begin_src shell
#+end_src
...
*** zlogin
:PROPERTIES:
:header-args: :tangle (org-sbe helper.org.resolve-path (vardir 'dir_v2.0.0) (path $".zlogin"))
:END:
...
*** zlogout
:PROPERTIES:
:header-args: :tangle (org-sbe helper.org.resolve-path (vardir 'dir_v2.0.0) (path $".zlogout"))
:END:
...
*** zshrc
:PROPERTIES:
:header-args: :tangle (org-sbe helper.org.resolve-path (vardir 'dir_v2.0.0) (path $".zshrc"))
:END:
...
#+begin_src shell
export ASDF_DATA_DIR="$HOME/.asdf"
extra_path=("$ASDF_DATA_DIR/shims")
asdf_update_java_home() {
  JAVA_HOME=$(realpath $(dirname $(readlink -f $(asdf which java)))/../)
  export JAVA_HOME;
}
