...
#+begin_src shell :tangle (concat (org-sbe helper.org.getvar (var 'basedir)) ".zshenv")
...
** zprofile
:PROPERTIES:
:header-args: :tangle (concat (org-sbe helper.org.getvar (var 'basedir)) ".zprofile")
:END:
...
:PROPERTIES:
:header-args: :tangle (concat (org-sbe helper.org.getvar (var 'basedir)) ".zlogin")
:END:
...
*** active
:PROPERTIES:
:header-args: :tangle (concat (org-sbe helper.org.getvar (var 'basedir)) ".zshrc")
:END:
...
** zlogout
:PROPERTIES:
:header-args: :tangle (concat (org-sbe helper.org.getvar (var 'basedir)) ".zlogout")
:END:
