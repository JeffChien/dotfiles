...
* init.el
:PROPERTIES:
:header-args: :tangle (concat (org-sbe helper.org.getvar (var 'basedir)) "init.el") :mkdirp yes
:END:
...
* packages.el
:PROPERTIES:
:header-args: :tangle (concat (org-sbe helper.org.getvar (var 'basedir)) "packages.el") :mkdirp yes
:END:
...
* config.el
:PROPERTIES:
:header-args: :tangle (concat (org-sbe helper.org.getvar (var 'basedir)) "config.el") :mkdirp yes
:END:
