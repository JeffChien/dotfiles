...
yabai_space < ctrl + shift - 0x2B    : yabai -m window --space prev # key=,
yabai_space < ctrl + shift - 0x2F    : yabai -m window --space next # key=.
...
## keybindings
yabai_monitor < shift - 0x2B : \
    yabai -m window --display prev; yabai -m display --focus prev # key=,
yabai_monitor < shift - 0x2F : \
    yabai -m window --display next; yabai -m display --focus next # key=.
yabai_monitor < ctrl+shift - 0x2B : yabai -m window --display prev # key=,
yabai_monitor < ctrl+shift - 0x2F : yabai -m window --display next # key=.
