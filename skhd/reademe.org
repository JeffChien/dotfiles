...
| .            | Focus next space                                          |
| S-,          | Move window to previous space and follow                  |
| S-.          | Move window to next space and follow                      |
| C-S-,        | Move window to previous space and stay                    |
| C-S-.        | Move window to next space and stay                        |
...
## keybindings
yabai_space < 0x2B : ~/bin/yabai-helper focus "space/@/-1"
yabai_space < 0x2F : ~/bin/yabai-helper focus "space/@/1"

## TODO, allowing cycle through spaces
yabai_space < shift - 0x2B    : ~/bin/yabai-helper throw "window/@" "space/@/-1" --follow
yabai_space < shift - 0x2F    : ~/bin/yabai-helper throw "window/@" "space/@/1" --follow
yabai_space < ctrl + shift - 0x2B    : ~/bin/yabai-helper throw "window/@" "space/@/-1"
yabai_space < ctrl + shift - 0x2F    : ~/bin/yabai-helper throw "window/@" "space/@/1"
...
| .          | Focus next monitor                         |
| S-,        | Move window to previous monitor and follow |
| S-.        | Move window to next monitor and follow     |
| C-S-,      | Move window to previous monitor and stay   |
| C-S-.      | Move window to next monitor and stay       |
| [123]      | Focus monitor #                            |
...
## keybindings
yabai_monitor < 0x2B : ~/bin/yabai-helper focus "display/@/-1"
yabai_monitor < 0x2F : ~/bin/yabai-helper focus "display/@/1"

yabai_monitor < shift - 0x2B : ~/bin/yabai-helper throw "window/@" "display/@/-1" --follow
yabai_monitor < shift - 0x2F : ~/bin/yabai-helper throw "window/@" "display/@/1" --follow
yabai_monitor < ctrl+shift - 0x2B : ~/bin/yabai-helper throw "window/@" "display/@/-1"
yabai_monitor < ctrl+shift - 0x2F : ~/bin/yabai-helper throw "window/@" "display/@/1"
...
default < f12 : ~/bin/yabai-helper guake --toggle --topmost --grid "20:20:0:15:20:5" '^Guake'
#+end_src
