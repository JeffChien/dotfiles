...
| hyper-m    | Active yabai mode                                      |
| hyper-n    | Active yabai space mode                                |
| hyper-b    | Active yabai monitor mode                        |
...
default < hyper - m ; yabai
default < hyper - n ; yabai_space
default < hyper - b ; yabai_monitor
